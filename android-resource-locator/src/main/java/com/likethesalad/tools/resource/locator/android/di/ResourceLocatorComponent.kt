...
import com.likethesalad.tools.resource.locator.android.extension.LanguageResourceFinderFactory
...
interface ResourceLocatorComponent {
    ...
    fun languageResourceFinderFactory(): LanguageResourceFinderFactory
}